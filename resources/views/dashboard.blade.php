        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <form id="form-sale">
                    <div class="mb-4">
                        ...
                        <select name="client_id" id="client_id" class="block mt-1 w-full border-gray-300 rounded">
                            ...
                            @foreach($clients as $client)
                                <option value="{{ $client->id }}" data-name="{{ $client->name }}" data-cpf="{{ $client->cpf }}" {{ old('client_id') == $client->id ? 'selected' : '' }}>
                                    {{ $client->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    {{-- Dados do cliente --}}
                    <div id="client-info" class="bg-gray-50 p-4 rounded border text-sm text-gray-800 hidden">
                        ...
                        <div class="flex flex-col lg:flex-row gap-8">
                            ...
                            <div class="flex flex-wrap gap-4 items-end flex-1">
                                ...
                                <div class="flex flex-col w-full sm:w-32">
                                    ...
                                    <input type="number" name="installments" id="installments" min="1" max="12" value="1" class="border-gray-300 rounded" />
                                </div>

                                <div class="flex flex-col w-full sm:w-44">
                                    <x-input-label for="due_date" :value="__('Data Vencimento')" />
                                    <input type="date" id="due_date" class="border-gray-300 rounded" />
                                </div>
                    ...
                    <div class="flex justify-end" id="valorTotal">
                    ...
                    <div class="flex justify-end">
                        <button type="button" id="salvarVenda" class="btn btn-primary px-3 py-2 text-white text-sm rounded">
                            <span class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true" id="spinnerSalvar"></span>
                            Salvar Venda
                        </button>
                    </div>
                </form>
